...
-  Keynote talks: The workshop will feature three keynote lectures from speakers coming from many different backgrounds to ensure we cover a wide range of topics from the Complex Systems world. Alessandro Laio, Silvia De Monte and Floriana Gargiulo have been confirmed as keynote speakers. Each keynote will last 90 minutes. The event will conclude on Friday 22nd with a closing event, followed by project presentations. 
...
-   Projects: Participants will split into groups and will formalize a research question. Preliminary results will be presented on the final day of the workshop. Attendees are encouraged to propose their own research questions so groups with shared interests can naturally form. Project proposals will be both presented and discussed by the participants during the workshop.

**Social activities:**

Since it is a bit early to spoil things out, we will keep some secrets for later. Confirmed ones are:

- Gathering and social event in Turin before leaving for the venue.
